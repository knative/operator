...
import (
	...
	serving "knative.dev/serving-operator/pkg/client/informers/externalversions/serving"
)
...
type SharedInformerFactory interface {
	...
	Operator() serving.Interface
}

func (f *sharedInformerFactory) Operator() serving.Interface {
