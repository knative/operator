...
readonly TARGET_RELEASE_VERSION="1.3"
# This is the branch name of knative repos, where we run the upgrade tests.
readonly KNATIVE_REPO_BRANCH="release-1.3"
