...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KnativeServing, desiredFinalizers sets.String) (*v1beta1.KnativeServing, error) {
	// Don't modify the informers copy.
