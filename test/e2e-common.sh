...
readonly TARGET_RELEASE_VERSION="1.0"
# This is the branch name of knative repos, where we run the upgrade tests.
readonly KNATIVE_REPO_BRANCH="release-1.0"
