...
import (
	...
	v1alpha1 "knative.dev/operator/pkg/client/informers/externalversions/eventing/v1alpha1"
...
func Get(ctx context.Context) v1alpha1.KnativeEventingInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/operator/pkg/client/informers/externalversions/eventing/v1alpha1.KnativeEventingInformer from context.")
	}
