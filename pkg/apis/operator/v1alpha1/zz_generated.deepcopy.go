...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngressConfigurations) DeepCopyInto(out *IngressConfigurations) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngressConfigurations.
func (in *IngressConfigurations) DeepCopy() *IngressConfigurations {
	if in == nil {
		return nil
	}
	out := new(IngressConfigurations)
	in.DeepCopyInto(out)
	return out
}
