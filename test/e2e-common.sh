...
readonly TARGET_RELEASE_VERSION="0.25"
# This is the branch name of knative repos, where we run the upgrade tests.
readonly KNATIVE_REPO_BRANCH="release-0.25"
