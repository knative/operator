...
// GetConfig implements Spec.
func (c *CommonSpec) GetConfig() Config {
	return c.Config
}

// GetRegistry implements Spec.
...
// CommonStatus unifies common fields and functions on the Status.
...
// GetVersion implements Status.
func (c *CommonStatus) GetVersion() string {
	return c.Version
}

// SetVersion implements Status.
func (c *CommonStatus) SetVersion(version string) {
	c.Version = version
}
