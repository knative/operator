...
func Install(ctx context.Context, newVersion string, manifest *mf.Manifest, status v1alpha1.KComponentStatus) error {
...
func RemoveClusterScoped(ctx context.Context, manifest *mf.Manifest) error {
	logger := logging.FromContext(ctx)
