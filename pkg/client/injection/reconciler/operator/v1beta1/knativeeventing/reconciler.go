...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KnativeEventing, desiredFinalizers sets.String) (*v1beta1.KnativeEventing, error) {
	// Don't modify the informers copy.
