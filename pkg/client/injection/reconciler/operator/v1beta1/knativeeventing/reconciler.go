...
// controller reconciling v1beta1.KnativeEventing.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1beta1.KnativeEventing. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1beta1.KnativeEventing) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1beta1.KnativeEventing.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1beta1.KnativeEventing. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1beta1.KnativeEventing) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1beta1.KnativeEventing if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1beta1.KnativeEventing.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1beta1.KnativeEventing) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1beta1.KnativeEventing) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1beta1.KnativeEventing resources.
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister operatorv1beta1.KnativeEventingLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) updateStatus(ctx context.Context, logger *zap.SugaredLogger, existing *v1beta1.KnativeEventing, desired *v1beta1.KnativeEventing) error {
	existing = existing.DeepCopy()
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		// The first iteration tries to use the injectionInformer's state, subsequent attempts fetch the latest state via API.
		if attempts > 0 {

			getter := r.Client.OperatorV1beta1().KnativeEventings(desired.Namespace)
		...
		updater := r.Client.OperatorV1beta1().KnativeEventings(existing.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.KnativeEventing, desiredFinalizers sets.Set[string]) (*v1beta1.KnativeEventing, error) {
...
func (r *reconcilerImpl) updateFinalizersFilteredServerSideApply(ctx context.Context, resource *v1beta1.KnativeEventing, desiredFinalizers sets.Set[string]) (*v1beta1.KnativeEventing, error) {
	...
	patcher := r.Client.OperatorV1beta1().KnativeEventings(resource.Namespace)
...
func (r *reconcilerImpl) updateFinalizersFilteredMergePatch(ctx context.Context, resource *v1beta1.KnativeEventing, desiredFinalizers sets.Set[string]) (*v1beta1.KnativeEventing, error) {
	// Don't modify the informers copy.
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1beta1.KnativeEventing) (*v1beta1.KnativeEventing, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.KnativeEventing, reconcileEvent reconciler.Event) (*v1beta1.KnativeEventing, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
	...
	if err != nil {
		...
		getter := r.Client.OperatorV1beta1().KnativeEventings(resource.Namespace)
